...
func TestWorkflowService_Create(t *testing.T) {
	...
	svc := NewWorkflowService(wRepo, eRepo, sRepo, nil, trx, nil, log)
...
func TestWorkflowService_List(t *testing.T) {
	wRepo := new(MockWorkflowRepository)
	svc := NewWorkflowService(wRepo, nil, nil, nil, nil, nil, logger.NewNop())
...
func TestWorkflowService_Update(t *testing.T) {
	...
	sRepo := new(MockStepExecutionRepository)
	trx := new(MockTrx)
	svc := NewWorkflowService(wRepo, eRepo, sRepo, nil, trx, nil, logger.NewNop())
